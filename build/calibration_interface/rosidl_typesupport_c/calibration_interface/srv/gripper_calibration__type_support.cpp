...
static const _GripperCalibration_Request_type_support_symbol_names_t _GripperCalibration_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, calibration_interface, srv, GripperCalibration_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, calibration_interface, srv, GripperCalibration_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, calibration_interface, srv, GripperCalibration_Request)() {
  return &::calibration_interface::srv::rosidl_typesupport_c::GripperCalibration_Request_message_type_support_handle;
}
...
static const _GripperCalibration_Response_type_support_symbol_names_t _GripperCalibration_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, calibration_interface, srv, GripperCalibration_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, calibration_interface, srv, GripperCalibration_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, calibration_interface, srv, GripperCalibration_Response)() {
  return &::calibration_interface::srv::rosidl_typesupport_c::GripperCalibration_Response_message_type_support_handle;
}
...
static const _GripperCalibration_type_support_symbol_names_t _GripperCalibration_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, calibration_interface, srv, GripperCalibration)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, calibration_interface, srv, GripperCalibration)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, calibration_interface, srv, GripperCalibration)() {
  return &::calibration_interface::srv::rosidl_typesupport_c::GripperCalibration_service_type_support_handle;
}
