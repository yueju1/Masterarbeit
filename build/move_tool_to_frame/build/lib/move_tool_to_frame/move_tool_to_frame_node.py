...
class MoveToolToFrame(rclpy.node.Node):
    ...
    def calculate_callback(self,future): 
        ...
        try:
            ...
            if response.success:
                ...
                deviation = math.sqrt(square)*self.sim_pixel_size
    ...
    def save_yaml(self):
        ...
        with open ("/home/pmlab/yueju/offset.yaml"
            ...
            joint_calibration['PM_Robot_Tool_TCP_Joint']['x_offset'] = self.error[0]*self.sim_pixel_size
            joint_calibration['PM_Robot_Tool_TCP_Joint']['y_offset'] = -self.error[1]*self.sim_pixel_size
